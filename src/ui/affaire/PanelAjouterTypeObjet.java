...
public class PanelAjouterTypeObjet extends JPanel implements ActionListener{
	...
	PanelAjouterTypeObjet(ScelleFenetre fen){
		fenetre = fen;
	...
	public void actionPerformed(ActionEvent e) {
		...
		{			
			...
			if(inputLibelle.getText().equals("")){
				...
				try {
					this.fenetre.getFacadeTypeObjet().ajouterTypeObjet(inputLibelle.getText());
				} catch (Exception e1) {
					e1.printStackTrace();
				}
